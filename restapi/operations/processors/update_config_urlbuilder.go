...
func (o *UpdateConfigURL) Build() (*url.URL, error) {
	...
	var _path = "/processor/{id}/run/{runID}/configuration"

	id := o.ID
	if id != "" {
		_path = strings.Replace(_path, "{id}", id, -1)
	} else {
		return nil, errors.New("id is required on UpdateConfigURL")
	}
	...
	if runID != "" {
		...
		return nil, errors.New("runId is required on UpdateConfigURL")
	}
