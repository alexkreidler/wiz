...
// @host localhost:8080
// @BasePath /
func NewServer(server api.ProcessorAPI) *Server {
...
func (s *Server) Setup() {
	...
	// Basic GET requests
	router.GET(fmt.Sprintf(api.ProcessorAPIEndpoints["GetAllProcessors"]), s.GetAllProcessors)
	router.GET(fmt.Sprintf(api.ProcessorAPIEndpoints["GetProcessor"], ":procID"), s.GetProcessor)
	router.GET(fmt.Sprintf(api.ProcessorAPIEndpoints["GetAllRuns"], ":procID"), s.GetAllRuns)
	router.GET(fmt.Sprintf(api.ProcessorAPIEndpoints["GetRun"], ":procID", ":runID"), s.GetRun)

	// Configuration and manipulation requests
	router.GET(fmt.Sprintf(api.ProcessorAPIEndpoints["GetConfig"], ":procID", ":runID"), s.GetConfig)
	router.POST(fmt.Sprintf(api.ProcessorAPIEndpoints["Configure"], ":procID", ":runID"), s.Configure)

	// Data reqs
	router.GET(fmt.Sprintf(api.ProcessorAPIEndpoints["GetData"], ":procID", ":runID"), s.GetData)
	router.POST(fmt.Sprintf(api.ProcessorAPIEndpoints["AddData"], ":procID", ":runID"), s.AddData)
